...
const electronAPI = {
    ...
    // 文件系统操作
    saveMarkdown: (id, title, content) => electron_1.ipcRenderer.invoke('save-markdown', id, title, content),
    loadAllMarkdown: () => electron_1.ipcRenderer.invoke('load-all-markdown'),
    deleteMarkdown: (id) => electron_1.ipcRenderer.invoke('delete-markdown', id),

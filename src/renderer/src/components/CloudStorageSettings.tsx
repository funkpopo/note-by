        ...
        return (
          <>
            <Form.Input
              field="url"
              label="WebDAV 服务器地址"
              placeholder={t('webdav.placeholders.serverUrl')}
              rules={[{ required: true, message: '请输入WebDAV服务器地址' }]}
            />
            <Form.Input
              field="username"
              label="用户名"
              placeholder={t('webdav.placeholders.username')}
            ...
            <Form.Input
              ...
              label="密码"
              mode="password"
              placeholder={t('webdav.placeholders.password')}
        ...
        return (
          <>
            <Form.Input
              field="auth.clientId"
              label="客户端 ID"
              placeholder={t('webdav.placeholders.clientId')}
            ...
            <Form.Input
              ...
              label="客户端密钥"
              mode="password"
              placeholder={t('webdav.placeholders.clientSecret')}
              rules={[{ required: true, message: '请输入客户端密钥' }]}
            />
            <Form.Input
              field="auth.redirectUri"
              label="重定向 URI"
              placeholder={t('webdav.placeholders.redirectUri')}
        ...
        return (
          <>
            <Form.Input
              field="auth.clientId"
              label="App Key"
              placeholder={t('webdav.placeholders.dropboxAppKey')}
            ...
            <Form.Input
              ...
              label="App Secret"
              mode="password"
              placeholder={t('webdav.placeholders.dropboxAppSecret')}
    ...
    <div className="cloud-storage-settings">
      ...
      >
        <Form.Select
          field="provider"
          label="云存储服务"
          placeholder={t('placeholders.selectCloudProvider')}
        ...
        <Form.Input
          field="remotePath"
          label="远程路径"
          placeholder={t('webdav.placeholders.remotePath')}
          initValue="/notes"
        ...
        <Form.Input
          field="localPath"
          label="本地路径"
          placeholder={t('webdav.placeholders.localPath')}
          disabled
          initValue=""
        />
      ...
      >
        <div>
          ...
          <Input
            ...
            placeholder={t('placeholders.enterAuthCode')}
            style={{ marginTop: 12 }}
          />
        </div>
      </Modal>

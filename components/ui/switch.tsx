...
>(({ className, ...props }, ref) => (
  ...
  >
    <SwitchPrimitives.Thumb
      className={cn(
        "data-[state=unchecked]:translate-x-0 data-[state=checked]:translate-x-5 pointer-events-none block h-5 w-5 rounded-full bg-background shadow-lg ring-0 transition-transform"
      )}
    />
  </SwitchPrimitives.Root>
))
